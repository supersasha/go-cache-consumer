...
var file_cache_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x63, 0x61, 0x63, 0x68, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x1c, 0x0a,
	0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x06, 0x0a, 0x04, 0x56,
	0x6f, 0x69, 0x64, 0x32, 0x30, 0x0a, 0x05, 0x43, 0x61, 0x63, 0x68, 0x65, 0x12, 0x27, 0x0a, 0x13,
	0x47, 0x65, 0x74, 0x52, 0x61, 0x6e, 0x64, 0x6f, 0x6d, 0x44, 0x61, 0x74, 0x61, 0x53, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x12, 0x05, 0x2e, 0x56, 0x6f, 0x69, 0x64, 0x1a, 0x05, 0x2e, 0x44, 0x61, 0x74,
	0x61, 0x22, 0x00, 0x30, 0x01, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x3b, 0x63, 0x61, 0x63, 0x68, 0x65,
...
var file_cache_proto_depIdxs = []int32{
	1, // 0: Cache.GetRandomDataStream:input_type -> Void
	0, // 1: Cache.GetRandomDataStream:output_type -> Data
...
type CacheClient interface {
	GetRandomDataStream(ctx context.Context, in *Void, opts ...grpc.CallOption) (Cache_GetRandomDataStreamClient, error)
}
...
func (c *cacheClient) GetRandomDataStream(ctx context.Context, in *Void, opts ...grpc.CallOption) (Cache_GetRandomDataStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Cache_serviceDesc.Streams[0], "/Cache/GetRandomDataStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *cacheGetRandomDataStreamClient) Recv() (*Data, error) {
	m := new(Data)
...
type CacheServer interface {
	GetRandomDataStream(*Void, Cache_GetRandomDataStreamServer) error
}
...
func (*UnimplementedCacheServer) GetRandomDataStream(*Void, Cache_GetRandomDataStreamServer) error {
...
func (x *cacheGetRandomDataStreamServer) Send(m *Data) error {
